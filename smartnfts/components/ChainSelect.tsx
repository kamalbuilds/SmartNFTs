...
import { Mumbai, BaseGoerli , MantleTestnet ,  PolygonZkevmTestnet , CeloAlfajoresTestnet , ScrollAlphaTestnet , ArbitrumSepolia } from '@thirdweb-dev/chains';

const ChainSelect: NextPage = () => {
  const { selectedChain, setSelectedChain } = useContext(ChainContext);

  const supportedChains = [BaseGoerli, Mumbai , MantleTestnet ,  PolygonZkevmTestnet , CeloAlfajoresTestnet , ScrollAlphaTestnet , ArbitrumSepolia];
  const chains = {
